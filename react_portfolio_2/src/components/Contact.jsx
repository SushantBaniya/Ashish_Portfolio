...
const Contact = () => {
  ...
  return (
    <section className="bg-slate-800 text-text_light" id="contact">
      <Toaster />
      <div className="md:container px-5 py-14">
        <h2 className="title !text-text_light" data-aos="fade-down">
          {Contact.title}
        </h2>
        ...
        <div className="flex gap-10 md:flex-row flex-col-reverse">
          ...
          >
            ...
            bg-dark_primary text-slate-900 font-bold"
            >
              Submit
            </button>
          </form>
